...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/isoduration-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14716&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/isoduration-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `isoduration` can be installed with:

```
conda install isoduration
```

It is possible to list all of the versions of `isoduration` available on your platform with:
